...
DEFAULT_SYSTEM_SETTINGS: Dict[str, str] = {
    ...
    "decision_calibration_metrics_json": "{}",
    "decision_calibration_last_computed_at": "",
    "recommended_confidence_buy_threshold": "70.0",
    "recommended_confidence_watch_threshold": "50.0",
}
