...
import { VARIANT_META, type VariantMeta } from './apps/web/src/config/variant-meta';
  ...
  async function buildRouter() {
    const [
      ...
      naturalServerMod, naturalHandlerMod,
        ...
        import('./apps/web/server/router'),
        import('./apps/web/server/cors'),
        import('./apps/web/server/error-mapper'),
        import('./apps/web/src/generated/server/worldmonitor/seismology/v1/service_server'),
        import('./apps/web/server/worldmonitor/seismology/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/wildfire/v1/service_server'),
        import('./apps/web/server/worldmonitor/wildfire/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/climate/v1/service_server'),
        import('./apps/web/server/worldmonitor/climate/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/prediction/v1/service_server'),
        import('./apps/web/server/worldmonitor/prediction/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/displacement/v1/service_server'),
        import('./apps/web/server/worldmonitor/displacement/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/aviation/v1/service_server'),
        import('./apps/web/server/worldmonitor/aviation/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/research/v1/service_server'),
        import('./apps/web/server/worldmonitor/research/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/unrest/v1/service_server'),
        import('./apps/web/server/worldmonitor/unrest/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/conflict/v1/service_server'),
        import('./apps/web/server/worldmonitor/conflict/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/maritime/v1/service_server'),
        import('./apps/web/server/worldmonitor/maritime/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/cyber/v1/service_server'),
        import('./apps/web/server/worldmonitor/cyber/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/economic/v1/service_server'),
        import('./apps/web/server/worldmonitor/economic/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/infrastructure/v1/service_server'),
        import('./apps/web/server/worldmonitor/infrastructure/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/market/v1/service_server'),
        import('./apps/web/server/worldmonitor/market/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/news/v1/service_server'),
        import('./apps/web/server/worldmonitor/news/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/intelligence/v1/service_server'),
        import('./apps/web/server/worldmonitor/intelligence/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/military/v1/service_server'),
        import('./apps/web/server/worldmonitor/military/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/positive_events/v1/service_server'),
        import('./apps/web/server/worldmonitor/positive-events/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/giving/v1/service_server'),
        import('./apps/web/server/worldmonitor/giving/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/trade/v1/service_server'),
        import('./apps/web/server/worldmonitor/trade/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/supply_chain/v1/service_server'),
        import('./apps/web/server/worldmonitor/supply-chain/v1/handler'),
        import('./apps/web/src/generated/server/worldmonitor/natural/v1/service_server'),
        import('./apps/web/server/worldmonitor/natural/v1/handler'),
      ]);
  ...
  return {
    ...
    configureServer(server) {
      ...
      server.watcher.on('change', (file) => {
        if (file.includes('/apps/web/server/') || file.includes('/apps/web/src/generated/server/')) {
          cachedRouter = null;
        }
      });
  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        child_process: resolve(__dirname, 'apps/web/src/shims/child-process.ts'),
        'node:child_process': resolve(__dirname, 'apps/web/src/shims/child-process.ts'),
